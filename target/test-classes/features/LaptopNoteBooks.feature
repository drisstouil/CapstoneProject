...
Scenario: Add and Remove a Mac book from Cart
 ...
 Then User should see a message3 'Success: You have added MacBook to your shopping cart!'
...
# @product
 ...
 Then User Should see a message4 'Success: You have added MacBook Air to your product comparison!'
